...
const PET_TYPES: PetType[] = [
  ...
  },
  {
    ...
    photos: [
      ...
      { url: "https://upload.wikimedia.org/wikipedia/commons/9/90/Aratinga_solstitialis_-captive-two-8a.jpg", caption: "Sun Conure", detail: "Coco, 6 yrs", fallback: "🦜" },
      { url: u("1517101724602-c257fe568157"), caption: "Cockatiel", detail: "Sunshine, 5 yrs", fallback: "🐦" },
      { url: "https://upload.wikimedia.org/wikipedia/commons/a/ad/Rainbow_lorikeet_%28Trichoglossus_moluccanus_moluccanus%29_Sydney.jpg", caption: "Rainbow Lorikeet", detail: "Sunny, 5 yrs", fallback: "🐦" },
      { url: "https://upload.wikimedia.org/wikipedia/commons/6/69/African_Rose-ringed_Parakeet%2C_Tendaba%2C_Gambia_1.jpg", caption: "African Ringneck", detail: "Mango, 3 yrs", fallback: "🐦" },
      { url: "https://upload.wikimedia.org/wikipedia/commons/4/4a/Budgerigar-male-strzelecki-qld.jpg", caption: "Budgerigar", detail: "Pickles, 4 yrs", fallback: "🦜" },
      { url: "https://upload.wikimedia.org/wikipedia/commons/a/a9/Cacatua_galerita_Tas_2.jpg", caption: "Cockatoo", detail: "Snowy, 10 yrs", fallback: "🦜" },
    ],
  },
  {
    id: "rabbit",
    ...
    photos: [
      { url: "https://upload.wikimedia.org/wikipedia/commons/6/66/Holland_Lop_Bunny_Standing_On_Her_Back_Feet.jpg", caption: "Holland Lop", detail: "Pebbles, 3 yrs", fallback: "🐇" },
